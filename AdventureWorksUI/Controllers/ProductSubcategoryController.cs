...
namespace AdventureWorks.UI.Controllers
{
    public class ProductSubcategoryController : Controller
    {
        ...
        private readonly string _baseUrl = "http://localhost:5217/api/ProductSubcategory";

        public ProductSubcategoryController(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<IActionResult> Index(int? categoryId)
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                return View(new List<ProductSubCategoryViewModel>());
            }

            var content = await response.Content.ReadAsStringAsync();
            var data = JsonConvert.DeserializeObject<List<ProductSubCategoryViewModel>>(content);
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            var item = JsonConvert.DeserializeObject<ProductSubCategoryViewModel>(json);
            return View(item);
        }
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var json = await response.Content.ReadAsStringAsync();
            var model = JsonConvert.DeserializeObject<ProductSubCategoryViewModel>(json);
            return View(model);
        }
